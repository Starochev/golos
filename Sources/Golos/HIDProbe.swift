...
///
/// Приёмники радиосистем, педали, пульты и прочее часто объявляют вендорскую
/// страницу вместо стандартной. Система такие кнопки в медиаклавиши
/// не превращает, и единственный способ понять, докладывает ли устройство
/// о нажатии вообще, это посмотреть сырые отчёты.
///
