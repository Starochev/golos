...
struct Config: Codable {
    ...
    ///
    /// По умолчанию точку убираем: диктуют обычно кусок в чат или в поле,
    /// а не законченный абзац, и точка там чаще мешает, чем помогает.
    /// Вопросительный и восклицательный остаются, они несут смысл.
    var finalPunctuation: String = "period"
