    ...
    var body: some View {
        Form {
            ...
            Section {
                ...
                Text("По умолчанию точка с конца убирается: диктуют обычно кусок в чат или в поле, а не законченный абзац. Вопросительный и восклицательный остаются, их модель ставит по смыслу, хотя и не всегда. Доставить недостающий знак снаружи нельзя, только убрать лишний. На расшифровку файлов не влияет.")
                    .font(.system(size: 11))
                    .foregroundStyle(.secondary)
                    .fixedSize(horizontal: false, vertical: true)
            } header: {
